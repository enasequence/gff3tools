...
public class AttributesRelationValidation implements FeatureValidation, AnnotationValidation {
    ...
    public void validateFeature(GFF3Feature feature, int line) throws ValidationException {
        ...
        if (feature.isAttributeExists(GFF3Attributes.CIRCULAR_RNA)) {
            Set<String> allowedFeatures = Set.of(
                    GFF3Anthology.CDS_FEATURE_NAME, GFF3Anthology.T_RNA_FEATURE_NAME, GFF3Anthology.M_RNA_FEATURE_NAME);
        ...
        validateExclusiveAttributes(feature, line);
        validateMutuallyRequiredAttributes(feature, line);
        validateMutuallyExclusiveAttributes(feature, line);
        validateMutuallyExclusiveAttributesByValue(feature, line);
    }

    @Override
    public void validateAnnotation(GFF3Annotation annotation, int line) throws ValidationException {
        validateRequiredAttributes(annotation, line);
    }

    private void validateExclusiveAttributes(GFF3Feature feature, int line) throws ValidationException {
    ...
    private void validateRequiredAttributes(GFF3Annotation annotation, int line) throws ValidationException {
    ...
    private void validateMutuallyRequiredAttributes(GFF3Feature feature, int line) throws ValidationException {
    ...
    private void validateMutuallyExclusiveAttributes(GFF3Feature feature, int line) throws ValidationException {
    ...
    private void validateMutuallyExclusiveAttributesByValue(GFF3Feature feature, int line) throws ValidationException {

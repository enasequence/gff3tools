...
public class AttributesValueValidation implements FeatureValidation, AnnotationValidation {
    ...
    public void validateFeature(GFF3Feature feature, int line) throws ValidationException {
        validateAttributesPattern(feature, line);
        validatePseudoGeneValue(feature, line);
        validateProteinValue(feature, line);
    }

    @Override
    public void validateAnnotation(GFF3Annotation annotation, int line) throws ValidationException {
        validateAttributeValueDependency(annotation, line);
    }

    private void validateAttributesPattern(GFF3Feature feature, int line) throws ValidationException {

        String featureName = feature.getName();
        if (featureName.equals(GFF3Anthology.R_RNA_FEATURE_NAME)
                || featureName.equals(GFF3Anthology.T_RNA_FEATURE_NAME)) {
    ...
    private void validateAttributeValueDependency(GFF3Annotation annotation, int line) throws ValidationException {
    ...
    private void validatePseudoGeneValue(GFF3Feature feature, int line) throws ValidationException {
    ...
    private void validateProteinValue(GFF3Feature feature, int line) throws ValidationException {

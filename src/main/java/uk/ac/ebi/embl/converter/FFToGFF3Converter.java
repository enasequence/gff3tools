...
public class FFToGFF3Converter {
  ...
  private void writeHeader(Entry entry, Writer writer, Feature feature) throws IOException {
    ...
    // # BACKPORT: source 1 315242 organism="Homo Sapiens";mol_type="gnomic DNA"

    writer.write("# BACKPORT source %s %d %d %s".formatted(accession, start, end, getAttributes(feature)));

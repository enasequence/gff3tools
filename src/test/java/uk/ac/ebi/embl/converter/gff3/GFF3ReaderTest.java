...
public class GFF3ReaderTest {
    ...
    void testMissingHeader() throws Exception {
        ...
        try {
            gff3Reader.readHeader();
            fail("Expected GFF3ValidationError for missing header");
    ...
    private GFF3Feature readSingleRecord(String gff3Content) throws IOException, GFF3ValidationError {
    ...
    void testInvalidPhaseForCDS() {
        ...
        try {
            ...
            fail("Expected GFF3ValidationError for invalid phase");
        } catch (GFF3ValidationError e) {
    ...
    void testMissingPhaseForCDS() {
        ...
        try {
            reader.readHeader();
            reader.readAnnotation();
            fail("Expected GFF3ValidationError for missing phase on CDS");
        } catch (GFF3ValidationError e) {
            Assertions.assertTrue(e.getMessage().toLowerCase().contains("phase"));
    ...
    void testNoEndOfLineComments() {
        ...
        try {
            ...
            fail("Expected GFF3ValidationError for end-of-line comment");
    ...
    void testUnescapedWhitespaceInSeqId() {
        ...
        try {
            reader.readHeader();
            reader.readAnnotation();
            fail("Expected GFF3ValidationError for unescaped whitespace in seqid");
        } catch (GFF3ValidationError e) {
    ...
    void testUnescapedSpecialCharInAttributeValue() {
        ...
        try {
            ...
            // (which is malformed).
            fail("Expected GFF3ValidationError for unescaped semicolon in attribute or malformed attribute");
        } catch (GFF3ValidationError e) {
            Assertions.assertTrue(e.getMessage().toLowerCase().contains("attribute"));
        } catch (IOException e) {
            fail("Unexpected IOException", e);
    ...
    void testInvalidNumberOfColumns() {
        ...
        try {
            reader.readHeader();
            reader.readAnnotation();
            fail("Expected GFF3ValidationError for wrong number of columns");
        } catch (GFF3ValidationError e) {
    ...
    void testInvalidStartEnd() {
        ...
        try {
            reader.readHeader();
            reader.readAnnotation();
            fail("Expected GFF3ValidationError for start > end");
        } catch (GFF3ValidationError e) {
    ...
    void testMalformedAttribute() {
        ...
        try {
            reader.readHeader();
            reader.readAnnotation();
            fail("Expected GFF3ValidationError for malformed attribute");
        } catch (GFF3ValidationError e) {
            Assertions.assertTrue(e.getMessage().toLowerCase().contains("attribute"));
        } catch (IOException e) {
            fail("Unexpected IOException", e);

...
public class AttributesRelationValidationTest {
    ...
    public void testValidateMutuallyRequiredAttributesSuccess() {
        ...
        Assertions.assertDoesNotThrow(() -> attributesRelationValidation.validateFeature(feature, 1));
    }
    ...
    public void testValidateMutuallyRequiredAttributesFailure() {
        ...
        ValidationException ex = Assertions.assertThrows(
                ValidationException.class, () -> attributesRelationValidation.validateFeature(feature, 1));
    ...
    public void testValidateRequiredAttributesInAnnotationSuccess() {
        ...
        Assertions.assertDoesNotThrow(() -> attributesRelationValidation.validateAnnotation(gff3Annotation, 1));
    }
    ...
    public void testValidateRequiredAttributesInAnnotationFailure() {
        ...
        ValidationException ex = Assertions.assertThrows(
                ValidationException.class, () -> attributesRelationValidation.validateAnnotation(gff3Annotation, 1));
    ...
    public void testValidateFeatureCircularRNASuccess() {
        ...
        Assertions.assertDoesNotThrow(() -> attributesRelationValidation.validateFeature(cds, 1));
        Assertions.assertDoesNotThrow(() -> attributesRelationValidation.validateFeature(trna, 2));
        Assertions.assertDoesNotThrow(() -> attributesRelationValidation.validateFeature(mrna, 3));
    }
    ...
    public void testValidateFeatureCircularRNAFailure() {
        ...
        Assertions.assertDoesNotThrow(() -> attributesRelationValidation.validateFeature(cds, 1));
        ValidationException ex = Assertions.assertThrows(
                ValidationException.class, () -> attributesRelationValidation.validateFeature(trna, 2));

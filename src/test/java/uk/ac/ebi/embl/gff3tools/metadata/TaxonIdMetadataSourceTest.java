...
class TaxonIdMetadataSourceTest {
    ...
    void unresolvedTaxonStillCarriesId() {
        TaxonProvider emptyProvider = new TaxonProvider() {
            @Override
            public Optional<Taxon> resolve(long taxId) {
        ...
        TaxonIdMetadataSource source = new TaxonIdMetadataSource(42L, emptyProvider);
        MasterMetadata meta = source.getMetadata("any").orElseThrow();
    ...
    void sameMetadataReturnedForAnySeqId() {
        ...
        TaxonIdMetadataSource source = new TaxonIdMetadataSource(9606L, emptyProvider);

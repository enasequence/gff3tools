...
public class GeneFeatureValidationTest {
    ...
    public void testValidateGeneLocusTagAssociationWithDuplicateLocusTags() {
        ...
        ValidationException ex = Assertions.assertThrows(
                ValidationException.class, () -> geneFeatureValidation.validateAnnotation(gff3Annotation, 1));
    ...
    public void testValidateGeneAssociationWithMultipleLocusTags() {
        ...
        GFF3Feature f3 = TestUtils.createGFF3Feature(
                GFF3Anthology.GENE_FEATURE_NAME, GFF3Anthology.GENE_FEATURE_NAME, Map.of(GFF3Attributes.GENE, "gene3"));
        gff3Annotation.setFeatures(List.of(f1, f2, f3));
    ...
    public void testValidateGeneAssociationWithRNAFeature() {
        ...
        GFF3Feature f3 = TestUtils.createGFF3Feature(
                GFF3Anthology.R_RNA_FEATURE_NAME,
                GFF3Anthology.R_RNA_FEATURE_NAME,
                Map.of(GFF3Attributes.GENE, "gene2"));
        gff3Annotation.setFeatures(List.of(f1, f2, f3));
    ...
    @Test
    public void testValidateLocusTagAssociationWithDifferentGeneAssociationSuccess() throws ValidationException {
        GFF3Feature cds = TestUtils.createGFF3Feature(
                GFF3Anthology.GENE_FEATURE_NAME,
                GFF3Anthology.CDS_FEATURE_NAME,
    ...
    @Test
    public void testValidateLocusTagAssociationWithDifferentGeneAssociationFailure() throws ValidationException {
        GFF3Feature cds = TestUtils.createGFF3Feature(
                GFF3Anthology.CDS_FEATURE_NAME,
                GFF3Anthology.CDS_FEATURE_NAME,
                Map.of(GFF3Attributes.LOCUS_TAG, "locus_tag1", GFF3Attributes.GENE, "gene1"));
    ...
    @Test
    public void testValidateLocusTagAssociationWithDifferentGeneSynonymAssociationFailure() throws ValidationException {
        GFF3Feature cds = TestUtils.createGFF3Feature(
                GFF3Anthology.CDS_FEATURE_NAME,
                GFF3Anthology.CDS_FEATURE_NAME,
                Map.of(
    ...
    public void testValidateLocusTagAssociationWithDifferentGeneNoSynonymAssociationSuccess()
        ...
        GFF3Feature sig = TestUtils.createGFF3Feature(
                GFF3Anthology.CDS_FEATURE_NAME,
                GFF3Anthology.CDS_FEATURE_NAME,
                Map.of(GFF3Attributes.LOCUS_TAG, "locus_tag1"));
        GFF3Feature prop = TestUtils.createGFF3Feature(
                GFF3Anthology.CDS_FEATURE_NAME,
                GFF3Anthology.CDS_FEATURE_NAME,
                Map.of(GFF3Attributes.LOCUS_TAG, "locus_tag2"));
        gff3Annotation.setFeatures(List.of(cds, sig, prop));
    ...
    @Test
    public void testValidateLocusTagAssociationWithDifferentGeneSynonymAssociationSuccess() throws ValidationException {
        GFF3Feature cds = TestUtils.createGFF3Feature(
                GFF3Anthology.CDS_FEATURE_NAME,
                GFF3Anthology.CDS_FEATURE_NAME,
                Map.of(

...
public class AttributesValueValidationTest {
    ...
    public void testValidateAttributesPatternTRNASuccess() {
        ...
        Assertions.assertDoesNotThrow(() -> attributesValueValidation.validateFeature(feature, 1));
    }
    ...
    public void testValidateAttributesPatternTRNAFailure() {
        ...
        ValidationException ex = Assertions.assertThrows(
                ValidationException.class, () -> attributesValueValidation.validateFeature(feature, 1));

        Assertions.assertTrue(ex.getMessage()
                .contains("Feature \"%s\" requires \"%s\" attributes with value matching the pattern"
                        .formatted(GFF3Anthology.T_RNA_FEATURE_NAME, GFF3Attributes.PRODUCT)));
    }
    ...
    public void testValidateAttributesPatternRRNAFailure() {
        ...
        Assertions.assertTrue(ex.getMessage()
                .contains("Feature \"%s\" requires \"%s\" attributes with value matching the pattern"
                        .formatted(GFF3Anthology.R_RNA_FEATURE_NAME, GFF3Attributes.PRODUCT)));
    }
    ...
    public void testValidateAttributeValueDependencySuccessNoGene() {
        ...
        Assertions.assertDoesNotThrow(() -> attributesValueValidation.validateAnnotation(gff3Annotation, 1));
    }
    ...
    public void testValidateAttributeValueDependencyFailureEmptyValue() {
        ...
        ValidationException ex = Assertions.assertThrows(
                ValidationException.class, () -> attributesValueValidation.validateAnnotation(gff3Annotation, 1));

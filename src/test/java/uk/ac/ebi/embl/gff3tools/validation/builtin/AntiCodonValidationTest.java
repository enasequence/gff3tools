...
public class AntiCodonValidationTest {
    ...
    public void testValidateCodonAttributes() {
        ...
        Assertions.assertDoesNotThrow(() -> antiCodonValidation.validateFeature(feature, 1));
    }

    @Test
    public void testValidateAntiCodonAttributeWithValidLength() {
        feature = TestUtils.createGFF3Feature(
                GFF3Anthology.R_RNA_FEATURE_NAME, 200, 989, Map.of(GFF3Attributes.ANTI_CODON, "(pos:250..252,aa:His)"));
    ...
    public void testValidateTranslExceptCodonAttributeWithValidLength() {
        feature = TestUtils.createGFF3Feature(
                ...
                200,
                989,
                Map.of(GFF3Attributes.TRANSL_EXCEPT, "(pos:250..252,aa:His)"));
    ...
    public void testValidateAntiCodonAttributeWithInvalidRange() {
        feature = TestUtils.createGFF3Feature(
                ...
                200,
                989,
                Map.of(GFF3Attributes.ANTI_CODON, "(pos:2520..2580,aa:His)"));

        ValidationException ex = Assertions.assertThrows(
                ValidationException.class, () -> antiCodonValidation.validateFeature(feature, 1));
    ...
    public void testValidateTranslExceptCodonAttributeWithInvalidRange() {
        feature = TestUtils.createGFF3Feature(
                ...
                200,
                989,
                Map.of(GFF3Attributes.TRANSL_EXCEPT, "(pos:2520..2580,aa:His)"));
    ...
    public void testValidateAntiCodonAttributeWithInvalidLengthSpan() {
        feature = TestUtils.createGFF3Feature(
                GFF3Anthology.R_RNA_FEATURE_NAME, 200, 989, Map.of(GFF3Attributes.ANTI_CODON, "(pos:252..258,aa:His)"));
    ...
    public void testValidateTranslExceptCodonAttributeWithInvalidLengthSpan() {
        feature = TestUtils.createGFF3Feature(
                ...
                200,
                989,
                Map.of(GFF3Attributes.TRANSL_EXCEPT, "(pos:252..258,aa:His)"));
    ...
    public void testValidateTranslExceptTermCodonAttributeWithInvalidLengthSpan() {
        feature = TestUtils.createGFF3Feature(
                ...
                200,
                989,
                Map.of(GFF3Attributes.TRANSL_EXCEPT, "(pos:252..258,aa:TERM)"));
    ...
    public void testValidateAntiCodonAttributeWithInvalidLocation() {
        feature = TestUtils.createGFF3Feature(
                GFF3Anthology.R_RNA_FEATURE_NAME, 200, 989, Map.of(GFF3Attributes.ANTI_CODON, "(pos:258..221,aa:His)"));
    ...
    public void testValidateTranslExceptCodonAttributeWithInvalidLocation() {
        feature = TestUtils.createGFF3Feature(
                ...
                200,
                989,
                Map.of(GFF3Attributes.TRANSL_EXCEPT, "(pos:258..221,aa:His)"));
    ...
    public void testValidateAntiCodonAttributeWithInvalidLocationStart() {
        feature = TestUtils.createGFF3Feature(
                GFF3Anthology.R_RNA_FEATURE_NAME, 0, 989, Map.of(GFF3Attributes.ANTI_CODON, "(pos:0..221,aa:His)"));
    ...
    public void testValidateTranslExceptCodonAttributeWithInvalidLocationStart() {
        feature = TestUtils.createGFF3Feature(
                GFF3Anthology.R_RNA_FEATURE_NAME, 0, 989, Map.of(GFF3Attributes.TRANSL_EXCEPT, "(pos:0..221,aa:His)"));
    ...
    public void testValidateAntiCodonAttributeInvalidAminoAcid() {
        feature = TestUtils.createGFF3Feature(
                GFF3Anthology.R_RNA_FEATURE_NAME, 100, 989, Map.of(GFF3Attributes.ANTI_CODON, "(pos:200..202,aa:Hi)"));
    ...
    public void testValidateTranslExceptCodonAttributeInvalidAminoAcid() {
        feature = TestUtils.createGFF3Feature(
                ...
                100,
                989,
                Map.of(GFF3Attributes.TRANSL_EXCEPT, "(pos:200..202,aa:Hi)"));
    ...
    @Test
    public void testValidateAntiCodonAttributeInvalidAminoAcidAbbreviation() throws ValidationException {
        feature = TestUtils.createGFF3Feature(
                GFF3Anthology.R_RNA_FEATURE_NAME, 200, 989, Map.of(GFF3Attributes.ANTI_CODON, "(pos:250..252,aa:HIS)"));
    ...
    @Test
    public void testValidateTranslExceptCodonAttributeInvalidAminoAcidAbbreviation() throws ValidationException {
        feature = TestUtils.createGFF3Feature(
                GFF3Anthology.R_RNA_FEATURE_NAME,
                200,
                989,
